  ...
  (
    ...
    const renderInput = () => {
      const inputProps = {
        ...
        className: cn(
          "flex h-full w-full bg-transparent px-0 py-0 text-sm text-foreground ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
