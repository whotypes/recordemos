...
import { GitHub } from "@/components/svg-repo";
		...
		<div className="relative flex h-full w-full flex-col bg-card">
				...
				<Link to="/" className="flex h-10 items-center gap-1">
					<span className="relative flex items-center justify-center">
						<img
							src="/rd_logo.png"
							alt="Record Demos"
							className="size-16 dark:brightness-75 before"
						/>
						<span className="absolute top-2 left-1/2 -translate-x-0.5 translate-y-3 flex h-3 w-3 items-center justify-center">
							<span className="animate-ping absolute inline-flex size-2.5 rounded-full bg-red-500 opacity-75" />
			...
			<div className="z-10 mx-auto flex w-full max-w-5xl flex-col gap-4 px-6">
				<div className="z-10 flex h-full w-full flex-col items-center justify-center gap-4 p-12 md:p-24">
					...
					>
						Star{" "}
						<Star className="w-4 h-4 mx-1 stroke-amber-300 fill-amber-300" />{" "}
						Record Demos on{" "}
						<GitHub className="size-4 ml-1.5 stroke-black stroke-width-2 fill-black" />
					</a>
					<HeroTitle />
				...
				<div className="flex w-full flex-col items-center justify-center gap-2">
					...
					<div className="my-8 flex flex-wrap items-center justify-center gap-10 gap-y-8 lg:gap-14">
						...
						>
							<img src="/autumn.png" alt="Autumn" className="size-14" />
						</a>
						<a
							target="_blank"
							rel="noreferrer"
				...
				<div className="relative z-10 flex flex-col border border-border backdrop-blur-sm lg:flex-row">
					...
					<div className="flex w-full flex-col items-center justify-center gap-6 p-10 lg:p-12">
						<ProPricingCards />
					</div>

					<div className="absolute left-0 top-0 z-10 flex flex-col items-center justify-center">
						<span className="absolute h-6 w-px bg-primary/40" />
						<span className="absolute h-px w-6 bg-primary/40" />
					</div>
			...
			<footer className="z-10 flex w-full flex-col items-center justify-center gap-8 py-6">
				...
				<div className="flex flex-col items-center gap-2 sm:flex-row">
					{/* Split the nested <p> so there is no <p> inside another <p> */}
					<div className="flex items-center whitespace-nowrap text-center text-sm font-medium text-primary/60">
						Based on&nbsp;
						<a
